...
public class ReadTextFile {
    ...
    public static void readRecords() {
        ...
        } catch (NullPointerException stateException) {
            System.err.println("Error lines null . Terminating.");
        } catch (RuntimeException elementException) {
            elementException.printStackTrace();
        }
    } // end method readRecords

    // close file and terminate applicationpublic static void closeFile()
